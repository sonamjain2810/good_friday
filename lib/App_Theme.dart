...
class AppTheme {
  ...
  static  Color _lightPrimaryColor = Colors.orange[50];
  static  Color _lightPrimaryVariantColor = Colors.brown[700];
  static const Color _lightSecondaryColor = Colors.grey;
  static  Color _lightOnPrimaryColor = Colors.orange[700];
  static  Color _lightPrimaryIconThemeColor = Colors.brown[700];
  static const Color _lightButtonTextColor = Colors.white;
  static  Color _lightButtonColor = Colors.orange[800];
  static   Color _lightButtonSplashColor = Colors.deepPurple;
  static  Color _lightAppBarTextColor = Colors.orange[800];
  static const Color _lightDividerColor = Colors.black;
  static  Color _lightCardColor = Colors.brown[700];
...
// yaha per sab color define kiye hai jo hame ThemeData me use karege dark Theme.
  ...
  static const Color _darkButtonSplashColor = Colors.greenAccent;
...
// light Appbar text Styling
  static final TextTheme _lightAppBarTextTextTheme = TextTheme(
    headline1: GoogleFonts.flavors(textStyle: _lightAppBarHeadline1TextStyle),
  );
  ...
  static final TextTheme _lightTextTheme = TextTheme(
    headline1: GoogleFonts.flavors(textStyle: _lightScreenHeading1TextStyle),
